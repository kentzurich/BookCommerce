        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price_50 = table.Column<double>(type: "float", nullable: false),
                    Price_100 = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Author", "Description", "ISBN", "ListPrice", "Price", "Price_100", "Price_50", "Title" },
                values: new object[,]
                {
