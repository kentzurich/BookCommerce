...
namespace BookCommerce_API.Migrations
{
    ...
    [Migration("20230615054027_addShoppingCartToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookCommerce_API.Model.OrderDetailsModel", b =>
                {
            ...
            modelBuilder.Entity("BookCommerce_API.Model.OrderHeaderModel", b =>
                {
            ...
            modelBuilder.Entity("BookCommerce_API.Model.ProductImageModel", b =>
                {
            ...
            modelBuilder.Entity("BookCommerce_API.Model.ShoppingCartModel", b =>
                {
            ...
            modelBuilder.Entity("BookCommerce_API.Model.ApplicationUserModel", b =>
                {
            ...
            modelBuilder.Entity("BookCommerce_API.Model.OrderDetailsModel", b =>
                {
                    b.HasOne("BookCommerce_API.Model.OrderHeaderModel", "OrderHeader")
                        .WithOne("OrderDetails")
                        .HasForeignKey("BookCommerce_API.Model.OrderDetailsModel", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookCommerce_API.Model.ProductModel", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BookCommerce_API.Model.OrderHeaderModel", b =>
                {
                    b.HasOne("BookCommerce_API.Model.ApplicationUserModel", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BookCommerce_API.Model.ApplicationUserModel", b =>
                {
                    b.HasOne("BookCommerce_API.Model.CompanyModel", "Company")
                        .WithMany()
